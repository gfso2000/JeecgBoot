...
@Slf4j
public class JackTestController extends JeecgController<JackTest, IJackTestService> {
	@Autowired
	private IJackTestService jackTestService;
	...
	public Result<IPage<JackTest>> queryPageList(JackTest jackTest,
        ...
        QueryWrapper<JackTest> queryWrapper = QueryGenerator.initQueryWrapper(jackTest, req.getParameterMap());
		Page<JackTest> page = new Page<JackTest>(pageNo, pageSize);
		IPage<JackTest> pageList = jackTestService.page(page, queryWrapper);
	...
	public Result<String> edit(@RequestBody JackTest jackTest) {
		jackTestService.updateById(jackTest);
	...
	public Result<String> deleteBatch(@RequestParam(name="ids",required=true) String ids) {
		this.jackTestService.removeByIds(Arrays.asList(ids.split(",")));
    ...
    * @param jackTest
    */
    @RequiresPermissions("jack:jack_test:exportXls")
    @RequestMapping(value = "/exportXls")
    public ModelAndView exportXls(HttpServletRequest request, JackTest jackTest) {
        return super.exportXls(request, jackTest, JackTest.class, "jack desc");
    }
    ...
    * @return
    */
    @RequiresPermissions("jack:jack_test:importExcel")
    @RequestMapping(value = "/importExcel", method = RequestMethod.POST)
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
        return super.importExcel(request, response, JackTest.class);
    }
